...
//#include "StdAfx.h"
#include "pch.h"
#include ".\GetAssayAllForPlate_CallBack.h"
#include <iostream>
using namespace std;
...
//==============================================================================================
//GetAssayAllForPlate_CallBack::GetAssayAllForPlate_CallBack(CArray<LONGLONG, LONGLONG>* m_plarrAssayID,
...
GetAssayAllForPlate_CallBack::GetAssayAllForPlate_CallBack(std::list<AssayPlate> assayPlateList) : assayPlateList(assayPlateList)
{
}
...
//==============================================================================================
BOOL GetAssayAllForPlate_CallBack::GetNextResult(MDCS_QueryResults* pQueryRes)
{
    ASSERT(pQueryRes);
    if (!pQueryRes)
        return TRUE;
