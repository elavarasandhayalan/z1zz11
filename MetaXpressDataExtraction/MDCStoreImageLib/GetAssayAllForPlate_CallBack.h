...
class GetAssayAllForPlate_CallBack :
    public MDCS_GetDBResultsCCallback
{
public:
   /* GetAssayAllForPlate_CallBack(CArray<LONGLONG, LONGLONG>* m_plarrAssayID,
        CArray<LPCSTR, LPCSTR>* m_plarrAssayName,
        CArray<LPCSTR, LPCSTR>* m_plarrAssayDescription,
        CArray<LPCSTR, LPCSTR>* m_plarrcreatedby);*/

   GetAssayAllForPlate_CallBack(std::list<AssayPlate> assayPlateLis);

    virtual ~GetAssayAllForPlate_CallBack(void) {}
...
private:
    ...
    GetAssayAllForPlate_CallBack(MDCS_GetDBResultsCCallback const&);
    const GetAssayAllForPlate_CallBack& operator=(MDCS_GetDBResultsCCallback const&);
